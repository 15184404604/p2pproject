            ...
            <div class="col-sm-9 col-xs-12" id="mainContent">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal el-borrow-form" id="borrowForm" novalidate="novalidate" method="post" action="${pageContext.request.contextPath}/borrow_normal.do">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                    借款类型
                                </label>
                                <div class="col-sm-3 input-group">
                                    <select name="borrowType" class="form-control" id="borrowType"> 
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary col-lg-offset-3" id="btnSubmit" type="button" data-loading-text="提交">
                                    提交申请
                                </button>
                            </div>
